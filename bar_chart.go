...
func (bc BarChart) getCanvasStyle() core.Style {
	return bc.Canvas.InheritFrom(bc.styleDefaultsCanvas())
}

func (bc BarChart) styleDefaultsCanvas() core.Style {
	return core.Style{
...
func (bc BarChart) getBackgroundStyle() core.Style {
	return bc.Background.InheritFrom(bc.styleDefaultsBackground())
}

func (bc BarChart) styleDefaultsBackground() core.Style {
	return core.Style{
...
func (bc BarChart) styleDefaultsBar(index int) core.Style {
	return core.Style{
...
func (bc BarChart) styleDefaultsTitle() core.Style {
...
func (bc BarChart) styleDefaultsAxes() core.Style {
	return core.Style{
...
func (bc BarChart) styleDefaultsElements() core.Style {
	return core.Style{
		Font: bc.GetFont(),
	}
}
