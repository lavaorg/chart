...
import (
	"github.com/lavaorg/test/lib/gotest"
	"testing"
)
...
func TestSeqMap(t *testing.T) {
	...
	gotest.AssertEqual(t, 4, mapped.Len())
}
...
func TestSeqFoldRight(t *testing.T) {
	...
	gotest.AssertEqual(t, -14, notFour)
}
...
func TestSeqSum(t *testing.T) {
	...
	values := Seq{NewArray(1, 2, 3, 4)}
	gotest.AssertEqual(t, 10, values.Sum())
}
...
func TestSeqAverage(t *testing.T) {
	...
	values := Seq{NewArray(1, 2, 3, 4)}
	gotest.AssertEqual(t, 2.5, values.Average())

	valuesOdd := Seq{NewArray(1, 2, 3, 4, 5)}
	gotest.AssertEqual(t, 3, valuesOdd.Average())
}
...
func TestSequenceVariance(t *testing.T) {
	...
	gotest.AssertEqual(t, 2, values.Variance())
}
...
func TestSequenceNormalize(t *testing.T) {
	...
	gotest.AssertNotEmpty(t, normalized)
	gotest.AssertLen(t, normalized, 5)
	gotest.AssertEqual(t, 0, normalized[0])
	gotest.AssertEqual(t, 0.25, normalized[1])
	gotest.AssertEqual(t, 1, normalized[4])
}
...
func TestLinearRange(t *testing.T) {
	...
	gotest.AssertLen(t, values, 100)
	gotest.AssertEqual(t, 1, values[0])
	gotest.AssertEqual(t, 100, values[99])
}
...
func TestLinearRangeWithStep(t *testing.T) {
	...
	gotest.AssertEqual(t, 100, values[20])
	gotest.AssertLen(t, values, 21)
}
...
func TestLinearRangeReversed(t *testing.T) {
	...
	gotest.AssertEqual(t, 10, len(values))
	gotest.AssertEqual(t, 10.0, values[0])
	gotest.AssertEqual(t, 1.0, values[9])
}
...
func TestLinearSequenceRegression(t *testing.T) {
	...
	gotest.AssertEqual(t, 1, linearProvider.Start())
	gotest.AssertEqual(t, 100, linearProvider.End())
	gotest.AssertEqual(t, 100, linearProvider.Len())

	values := Seq{linearProvider}.Values()
	gotest.AssertLen(t, values, 100)
	gotest.AssertEqual(t, 1.0, values[0])
	gotest.AssertEqual(t, 100, values[99])
}
